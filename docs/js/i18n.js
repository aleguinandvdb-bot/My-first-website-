...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "hero.lede": "Stone-milled pastry, single-origin espresso, and a warm corner of Provence in the heart of Rockville.",
      "hero.cta1": "View the Menu",
      "hero.cta2": "Call to Reserve",
      "hero.drinkLatte": "Latte",
      "hero.drinkSoda": "Soda Cream Latte",
      "hero.drinkLemonade": "Cherry Lemonade",
      "hero.drinkBlossom": "Cherry Blossom Latte",
      ...
      "menu.cat1": "Coffee",
      "menu.cat5": "Café Latte Specialty",
      "menu.cat6": "Specialty Coffee",
      "menu.cat7": "Non-Coffee",
      "menu.hotOnly": "hot only",
      "menu.icedOnly": "iced only",
      "menu.londonFog": "Earl Grey tea latte",
    ...
    fr: {
      ...
      "nav.contact": "Contact",
      "nav.call": "Appeler le (301) 233-1654",
      ...
      "hero.lede": "Pâtisserie à la meule de pierre, espresso d'origine unique, et un coin chaleureux de Provence au cœur de Rockville.",
      "hero.cta1": "Voir le menu",
      "hero.cta2": "Appeler pour réserver",
      "hero.drinkLatte": "Latte",
      "hero.drinkSoda": "Latte crème soda",
      "hero.drinkLemonade": "Limonade à la cerise",
      "hero.drinkBlossom": "Latte à la fleur de cerisier",
      ...
      "menu.cat1": "Café",
      "menu.cat5": "Lattes Spécialités",
      "menu.cat6": "Cafés Spéciaux",
      "menu.cat7": "Sans Café",
      "menu.hotOnly": "chaud uniquement",
      "menu.icedOnly": "glacé uniquement",
      "menu.londonFog": "latte au thé Earl Grey",
      "menu.cat2": "Pâtisserie",
    ...
    es: {
      ...
      "nav.call": "Llamar al (301) 233-1654",
      ...
      "hero.lede": "Repostería de piedra molida, espresso de origen único y un cálido rincón de Provence en el corazón de Rockville.",
      "hero.cta1": "Ver el menú",
      "hero.cta2": "Llamar para reservar",
      "hero.drinkLatte": "Latte",
      "hero.drinkSoda": "Latte de crema de soda",
      "hero.drinkLemonade": "Limonada de cereza",
      "hero.drinkBlossom": "Latte de flor de cerezo",
      ...
      "menu.cat1": "Café",
      "menu.cat5": "Lattes de Especialidad",
      "menu.cat6": "Cafés de Especialidad",
      "menu.cat7": "Sin Café",
      "menu.hotOnly": "solo caliente",
      "menu.icedOnly": "solo frío",
      "menu.londonFog": "latte de té Earl Grey",
