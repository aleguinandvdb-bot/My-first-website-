...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "process.finaleTitle": "Start to finish",
      "process.finaleDesc": "Grind, brew, steam, pour, sweeten — watch the whole cup come together in one go.",
      "process.brewAllButton": "Make the whole coffee",
      "process.brewAllGrinding": "Grinding the beans…",
      "process.brewAllBrewing": "Brewing…",
      "process.brewAllSteaming": "Steaming the milk…",
      "process.brewAllPouring": "Pouring it in…",
      "process.brewAllSugar": "Adding sugar…",
      "process.brewAllDone": "Enjoy! Make it again?",
    ...
    fr: {
      ...
      "process.finaleTitle": "Du début à la fin",
      "process.finaleDesc": "Moudre, infuser, chauffer à la vapeur, verser, sucrer — regardez toute la tasse prendre forme d'un seul geste.",
      "process.brewAllButton": "Préparer tout le café",
      "process.brewAllGrinding": "Mouture des grains…",
      "process.brewAllBrewing": "Infusion…",
      "process.brewAllSteaming": "Chauffe du lait à la vapeur…",
      "process.brewAllPouring": "Versement…",
      "process.brewAllSugar": "Ajout du sucre…",
      "process.brewAllDone": "Bon appétit ! Recommencer ?",
    ...
    es: {
      ...
      "process.finaleTitle": "De principio a fin",
      "process.finaleDesc": "Moler, preparar, vaporizar, verter, endulzar — mira cómo se forma toda la taza de una vez.",
      "process.brewAllButton": "Preparar todo el café",
      "process.brewAllGrinding": "Moliendo los granos…",
      "process.brewAllBrewing": "Preparando…",
      "process.brewAllSteaming": "Vaporizando la leche…",
      "process.brewAllPouring": "Sirviendo…",
      "process.brewAllSugar": "Añadiendo azúcar…",
      "process.brewAllDone": "¡Disfrútalo! ¿Preparar otro?",
